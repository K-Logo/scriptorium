...
export default async function handler(req, res) {
    if (req.method === "GET") {
        ...
        let sortedComments = paginate(epp, pno, await commentsDb.getSortedComments(order));  // if entries per page or page number are null, their defaults are 20 and 1, respectively
